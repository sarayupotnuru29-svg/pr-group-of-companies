  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      <div className="container-corporate py-16">
        ...
        {/* Business Hours & Copyright Section */}
        <div className="mt-12 pt-8 border-t border-primary-foreground/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left mb-6">
            <div className="text-sm text-primary-foreground/60">
              <span className="font-semibold text-primary-foreground/80">Business Hours:</span>{" "}
              Mon–Fri: 9AM–5PM | Sat: 9AM–3PM | Sun: Holiday
            </div>
          ...
          {/* Centered StaffArc Credit */}
          <div className="flex justify-center items-center gap-1 text-sm border-t border-primary-foreground/10 pt-6">
            <span className="text-primary-foreground/60">Made with</span>
            <Heart className="h-4 w-4 text-red-500 fill-red-500 mx-0.5" />
            <span className="text-primary-foreground/60 mr-1">by</span>
            <a
              href="https://staffarc.in"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-orange-500 hover:text-orange-400 transition-colors font-medium"
            >
              <img
